...
const Hero = () => {
  ...
  <span className="text-right">✉️ nishantsharma@gmail.com</span>
</div>
      </div>
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                },
                {
                  ...
                  href: "https://www.linkedin.com/in/nishantsharma33/",
                },
                {
                  icon: <Mail size={24} />,
                  href: "mailto:nishantsharma@gmail.com", // ✅ fixed
                },
              ].map((social, idx) => (
                <a
                  key={idx}
