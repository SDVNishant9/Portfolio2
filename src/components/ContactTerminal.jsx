...
const ContactTerminal = () => {
  ...
  useEffect(() => {
    ...
    addLine("Type 'connect nishant sharma' to establish secure link");
  }, []);
  ...
  const handleCommand = (cmd) => {
    ...
    if (step === "connect") {
      if (cmd.toLowerCase() === "connect nishant sharma") {
        ...
        addLine("Invalid command. Use: connect nishant sharma");
      }
    }
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-pine-teal rounded-[2.5rem] border border-dark-teal/30 shadow-[0_40px_120px_rgba(8,44,45,0.4)] overflow-hidden">
          ...
          <div className="px-6 py-3 text-[10px] text-pale-oak/20 tracking-widest border-t border-white/5">
            NODE: NISHANT_CORE · STATUS: ACTIVE · LATENCY: 42ms
          </div>
        </div>
      </div>
    </section>
